...
## 调用参数 {#publick-parameter .section}
...
## 发起认证请求 {#section_d2z_5g4_1gb .section}
...
|BLOB|String|是|人脸 BLOB 数据，需要通过客户端 SDK 获取（详见 [iOS接入](cn.zh-CN/开发指南/接入纯客户端活体检测/iOS客户端接入指南.md#) 和 [Android接入](cn.zh-CN/开发指南/接入纯客户端活体检测/Android客户端接入指南.md#)）。|无|
...
## 完整代码示例（Java语言） {#section_ebp_zg4_1gb .section}
...
public class PopTestV2 {
    ...
    public static String doPOPRequest(String appKey, String appSecret, String url, String action, String v,
        ...
        // 参考文档：iyun.com/document_detail/66453.html
